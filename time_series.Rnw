...
\newcommand{\ti}[1]{\textcolor{azul}{\textbf{\texttt{#1}}}} % funciones código
...
knit_hooks$set(document = function(x) {sub('\\usepackage[]{color}', 
 ...
 pacman::p_load(scales, fpp3, tidyverse)
...
<<motor, child='secciones/01_marco_teorico.Rnw'>>=

@



<<bib, child='secciones/09_bibliografia.Rnw'>>=
