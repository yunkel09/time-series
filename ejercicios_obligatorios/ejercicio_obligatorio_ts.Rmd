...
pacman::p_load(tictoc, scales, tsbox, latex2exp, fpp3, tidyverse)
```
...
e <- tsCV(ts(volcan_raw, start = c(1500)), far2, h = 1)
...
res |> 
 ...
 labs(title = glue("Desempeño de los modelos para un horizonte de 1 a 5 años"),
